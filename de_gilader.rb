...
DataMapper.repository(:tunisia){User.count}
tt = DataMapper.repository(:tunisia){Tweet.count}
ttd = DataMapper.repository(:tunisia){Tweet.count(:twitter_id => nil)}
DataMapper.repository(:iran){User.count}
DataMapper.repository(:egypt){User.count}
def old_shit
